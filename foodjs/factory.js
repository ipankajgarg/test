app.factory("myfactory",($http,$q)=>{
    var object = {
        ...
        favproduct : function(){
          var pr = $q.defer();
         var url = "http://ec2-34-208-181-152.us-west-2.compute.amazonaws.com/users/8506078226/";
      ...
      var match =  this.arr.filter(function(obj){
        ...
        callfav : function(obj,no,val){
            console.log(obj)
              var pr = $q.defer();
         var url = "http://ec2-34-208-181-152.us-west-2.compute.amazonaws.com/users/favs/"+no+"/"+val+"/";
